          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] mb-8 lg:mb-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <a href="https://play.google.com/store/apps/details?id=biz.earningscall.app" aria-label="Get it on Google Play" target="_blank" rel="noopener noreferrer">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                ...
                <a href="https://apps.apple.com/app/id1626859464" aria-label="Download on the App Store" target="_blank" rel="noopener noreferrer">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
