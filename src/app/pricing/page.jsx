...
import { faqs, plans, refundConditions } from "@/data/pricing";
          ...
          <div className="max-w-[907px] mx-auto flex flex-col items-center gap-4 text-center">
              ...
              {["individual", "commercial"].map((val) => (
                <button
                  ...
                  style={{
                    ...
                    transition: "all 0.2s",
                    backgroundColor:
                      audience === val ? "#013214" : "transparent",
                    color: audience === val ? "#fff" : "#013214",
                    borderRadius:
                      val === "individual" ? "6px 0 0 6px" : "0 6px 6px 0",
                    borderLeft:
                      val === "commercial" ? "none" : "1px solid #013214",
                  }}
                >
            ...
            <p
              style={{
                ...
                fontFamily:
                  '"Stack Sans Headline", var(--font-stack-sans-headline), sans-serif',
                fontSize: "clamp(13px, 1.8vw, 16px)",
                fontStyle: "normal",
                fontWeight: 300,
                lineHeight: "24px",
                ...
                >
                  <span
                    style={{
                      ...
                      top: "2px",
                      left:
                        billing === "annual" ? "clamp(12px, 3vw, 22px)" : "2px",
                ...
                <div className="flex items-center justify-center">
                  <div
                    style={{
                      ...
                      gap: "24px",
                      borderRadius: "16px",
                      border: "0.5px solid rgba(164,164,164,0.40)",
                      background: "#0B3C1E",
                    }}
                  >
                    {/* SSL/TLS card */}
                    <div
                      style={{
                        borderRadius: "12px",
                        border: "0.5px solid rgba(164,164,164,0.60)",
                        background: "#154628",
                        display: "flex",
                        padding: "16px",
                        alignItems: "center",
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <path
                            d="M25.4395 13.8403H4.06029C3.68208 13.8403 3.31537 13.9699 3.02115 14.2075L2.24069 14.8378C0.823588 15.9823 0 17.7061 0 19.5276V38.346C0 39.2594 0.740464 39.9999 1.6539 39.9999H27.8459C28.7593 39.9999 29.4998 39.2594 29.4998 38.346V19.5276C29.4998 17.7061 28.6762 15.9823 27.2591 14.8379L26.4787 14.2076C26.1844 13.9699 25.8177 13.8403 25.4395 13.8403Z"
                            fill="url(#paint0_linear_769_282)"
                          />
                          <path
                            d="M6.86232 16.7746C8.20919 16.7746 9.30105 16.3442 9.30105 15.8132C9.30105 15.2822 8.20919 14.8518 6.86232 14.8518C5.51544 14.8518 4.42358 15.2822 4.42358 15.8132C4.42358 16.3442 5.51544 16.7746 6.86232 16.7746Z"
                            fill="url(#paint1_linear_769_282)"
                          />
                          <path
                            d="M22.6111 16.7746C23.958 16.7746 25.0498 16.3442 25.0498 15.8132C25.0498 15.2822 23.958 14.8518 22.6111 14.8518C21.2642 14.8518 20.1724 15.2822 20.1724 15.8132C20.1724 16.3442 21.2642 16.7746 22.6111 16.7746Z"
                            fill="url(#paint2_linear_769_282)"
                          />
                          <path
                            d="M29.5003 38.346V19.5275C29.5003 17.706 28.6768 15.9822 27.2596 14.8378L26.4792 14.2075C26.185 13.9699 25.8183 13.8403 25.4401 13.8403H7.599L5.33667 16.1027L28.8747 39.6409C29.2557 39.3378 29.5003 38.8706 29.5003 38.346Z"
                            fill="url(#paint3_linear_769_282)"
                          />
                          <path
                            d="M14.7505 36.5666C13.2854 36.5666 12.0933 35.3746 12.0933 33.9094V31.3467C12.0933 30.7911 11.8507 30.2731 11.4276 29.9253C10.1575 28.881 9.46188 27.3394 9.51915 25.6956C9.56618 24.3438 10.1323 23.0763 11.113 22.1267C12.0933 21.1775 13.378 20.6521 14.7306 20.647H14.7505C17.6369 20.647 19.9852 22.9952 19.9852 25.8816C19.9852 27.4524 19.2885 28.9262 18.0738 29.925C17.6505 30.2731 17.4077 30.7912 17.4077 31.3467V33.9095C17.4077 35.3746 16.2157 36.5666 14.7505 36.5666Z"
                            fill="url(#paint4_linear_769_282)"
                          />
                          <path
                            d="M14.7505 36.5666C13.2854 36.5666 12.0933 35.3746 12.0933 33.9094V31.3467C12.0933 30.7911 11.8507 30.2731 11.4276 29.9253C10.1575 28.881 9.46188 27.3394 9.51915 25.6956C9.56618 24.3438 10.1323 23.0763 11.113 22.1267C12.0933 21.1775 13.378 20.6521 14.7306 20.647H14.7505C17.6369 20.647 19.9852 22.9952 19.9852 25.8816C19.9852 27.4524 19.2885 28.9262 18.0738 29.925C17.6505 30.2731 17.4077 30.7912 17.4077 31.3467V33.9095C17.4077 35.3746 16.2157 36.5666 14.7505 36.5666Z"
                            fill="url(#paint5_linear_769_282)"
                          />
                          <path
                            d="M0 20.5851V38.3459C0 39.2594 0.740464 39.9999 1.6539 39.9999H27.8459C28.7593 39.9999 29.4998 39.2594 29.4998 38.3459V20.5851H0Z"
                            fill="url(#paint6_linear_769_282)"
                          />
                          <path
                            d="M27.2592 14.8378L26.4788 14.2075C26.1846 13.9699 25.8178 13.8403 25.4396 13.8403H15.2837V39.9999H27.846C28.7594 39.9999 29.4998 39.2594 29.4998 38.346V19.5275C29.4998 17.706 28.6763 15.9822 27.2592 14.8378Z"
                            fill="url(#paint7_linear_769_282)"
                          />
                          <path
                            d="M27.2596 14.8378L26.4791 14.2075C26.1849 13.9699 25.8181 13.8403 25.44 13.8403H23.3112L21.0784 16.0731L29.5002 24.4949V19.5276C29.5002 17.706 28.6766 15.9822 27.2596 14.8378Z"
                            fill="url(#paint8_linear_769_282)"
                          />
                          <path
                            d="M24.331 9.5807V15.8134C24.331 16.182 23.5733 16.4807 22.6382 16.4807C21.7037 16.4807 20.9454 16.182 20.9454 15.8134V9.5807C20.9454 6.16414 18.1661 3.38563 14.7503 3.38563C11.3346 3.38563 8.55528 6.16414 8.55528 9.5807V15.8134C8.55528 16.182 7.79693 16.4807 6.86248 16.4807C5.92725 16.4807 5.16968 16.182 5.16968 15.8134V9.5807C5.16968 4.29758 9.46715 0 14.7503 0C20.0335 0 24.331 4.29758 24.331 9.5807Z"
                            fill="url(#paint9_linear_769_282)"
                          />
                          <path
                            d="M14.75 0C14.6135 0 14.4778 0.00359375 14.3425 0.00921875V3.40055C14.4774 3.39172 14.613 3.3857 14.75 3.3857C18.1658 3.3857 20.9451 6.16422 20.9451 9.58078V15.8134C20.9451 16.1821 21.7034 16.4808 22.6379 16.4808C23.5731 16.4808 24.3307 16.1821 24.3307 15.8134V9.58078C24.3307 4.29758 20.0332 0 14.75 0Z"
                            fill="url(#paint10_linear_769_282)"
                          />
                          <path
                            d="M6.86321 16.4809C7.79766 16.4809 8.55601 16.1822 8.55601 15.8135V9.58088C8.55601 9.30994 8.57539 9.04361 8.60929 8.78174H5.204C5.18213 9.04533 5.17041 9.31174 5.17041 9.58088V15.8135C5.17041 16.1821 5.92806 16.4809 6.86321 16.4809Z"
                            fill="url(#paint11_linear_769_282)"
                          />
                          <path
                            d="M20.9459 9.58088V15.8135C20.9459 16.1822 21.7042 16.4809 22.6387 16.4809C23.5739 16.4809 24.3315 16.1822 24.3315 15.8135V9.58088C24.3315 9.31174 24.3197 9.04533 24.2979 8.78174H20.8926C20.9264 9.04361 20.9459 9.30994 20.9459 9.58088Z"
                            fill="url(#paint12_linear_769_282)"
                          />
                          <path
                            d="M18.8559 25.8813C18.8559 23.6083 17.009 21.7667 14.7341 21.7752C12.5438 21.7834 10.7226 23.5456 10.6464 25.7346C10.5998 27.0717 11.1931 28.2717 12.1437 29.0531C12.8287 29.6163 13.2213 30.4596 13.2213 31.3463V33.9092C13.2213 34.7534 13.9056 35.4378 14.7498 35.4378C15.5941 35.4378 16.2784 34.7534 16.2784 33.9092V31.3463C16.2784 30.4595 16.6712 29.6161 17.3563 29.0529C18.2719 28.3002 18.8559 27.1592 18.8559 25.8813Z"
                            fill="url(#paint13_linear_769_282)"
                          />
                          <path
                            d="M18.8559 25.8813C18.8559 23.6083 17.009 21.7667 14.7341 21.7752C12.5438 21.7834 10.7226 23.5456 10.6464 25.7346C10.5998 27.0717 11.1931 28.2717 12.1437 29.0531C12.8287 29.6163 13.2213 30.4596 13.2213 31.3463V33.9092C13.2213 34.7534 13.9056 35.4378 14.7498 35.4378C15.5941 35.4378 16.2784 34.7534 16.2784 33.9092V31.3463C16.2784 30.4595 16.6712 29.6161 17.3563 29.0529C18.2719 28.3002 18.8559 27.1592 18.8559 25.8813Z"
                            fill="url(#paint14_linear_769_282)"
                          />
                          <path
                            d="M18.8559 25.8813C18.8559 23.6083 17.009 21.7667 14.7341 21.7752C12.5438 21.7834 10.7226 23.5456 10.6464 25.7346C10.5998 27.0717 11.1931 28.2717 12.1437 29.0531C12.8287 29.6163 13.2213 30.4596 13.2213 31.3463V33.9092C13.2213 34.7534 13.9056 35.4378 14.7498 35.4378C15.5941 35.4378 16.2784 34.7534 16.2784 33.9092V31.3463C16.2784 30.4595 16.6712 29.6161 17.3563 29.0529C18.2719 28.3002 18.8559 27.1592 18.8559 25.8813Z"
                            fill="url(#paint15_linear_769_282)"
                          />
                          <path
                            d="M18.8559 25.8813C18.8559 23.6083 17.009 21.7667 14.7341 21.7752C12.5438 21.7834 10.7226 23.5456 10.6464 25.7346C10.5998 27.0717 11.1931 28.2717 12.1437 29.0531C12.8287 29.6163 13.2213 30.4596 13.2213 31.3463V33.9092C13.2213 34.7534 13.9056 35.4378 14.7498 35.4378C15.5941 35.4378 16.2784 34.7534 16.2784 33.9092V31.3463C16.2784 30.4595 16.6712 29.6161 17.3563 29.0529C18.2719 28.3002 18.8559 27.1592 18.8559 25.8813Z"
                            fill="url(#paint16_linear_769_282)"
                          />
                          <defs>
                            <linearGradient
                              id="paint0_linear_769_282"
                              x1="14.7499"
                              y1="15.5867"
                              x2="14.7499"
                              y2="22.2504"
                        ...
                        >
                          ...
                          <defs>
                            <linearGradient
                              ...
                              gradientUnits="userSpaceOnUse"
                            >
                              <stop stopColor="#C89600" />
                              <stop offset="1" stopColor="#FFC800" />
                            </linearGradient>
                            <linearGradient
                              id="paint1_linear_769_243"
                              x1="44.9181"
                              y1="24.8542"
                              x2="44.9181"
                              y2="22.698"
                              gradientUnits="userSpaceOnUse"
                            >
                              <stop stopColor="#643C00" />
                              <stop offset="1" stopColor="#825A00" />
                            </linearGradient>
                            <linearGradient
                              id="paint2_linear_769_243"
                              x1="42.7313"
                              y1="24.852"
                              x2="42.7313"
                              y2="22.676"
